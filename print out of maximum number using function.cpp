// print out of maximum number using function.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(){
    ...
    cout << "The maximum is " << MaxNum(num1, num2, num3);
